...
<div class="container">
  ...
  <div class="sidebar">
    <ul class="menu-list">
      <li class="menu-item active">
        <a href="#Chicken">
          <img src="https://file.hstatic.net/1000242782/collection/img_5730_89346f006a004885a5d2fa67a3f10583_thumb.png" alt="" />
          <span>Gà Rán - Cơm - Burger</span>
        </a>
      </li>
      <li class="menu-item">
        <a href="#Combo">
          <img src="https://file.hstatic.net/1000242782/collection/nhom_san_pham-01_75b077ffb5f94e53bf1f5c7ea09a6a9c_thumb.jpg" alt="" />
          <span>Otoké Combo</span>
        </a>
      </li>
      <li class="menu-item">
        <a href="#SideDishes">
          <img src="https://file.hstatic.net/1000242782/collection/nhom_san_pham-02-01-01_c69aa42a5a944a34b1067d35e5fd8e9e_thumb.jpg" alt="" />
          <span>Thức ăn kèm</span>
        </a>
      </li>
      <li class="menu-item">
        <a href="#Beverages">
          <img src="https://file.hstatic.net/1000242782/collection/nhom_san_pham-02-01-013-01_777b166133874099b219774378eb0db5_thumb.jpg" alt="" />
          <span>Tráng miệng & Thức uống</span>
        </a>
      </li>
      <li class="menu-item">
        <a href="#Sale">
          <img src="https://file.hstatic.net/1000242782/collection/web_2d7d275686304426965755fb666781e6_thumb.jpg" alt="" />
  ...
  <div class="main-content">
    ...
    <!-- ăn kèm -->
    <div>
      <h3 id="SideDishes">THỨC ĂN KÈM</h3>
      <div class="product-grid">
        <?php
  ...
  <div class="checkout">
    <div class="cart-summary">
      <button class="checkout-btn" onclick="window.location.href='/otoke-chicken/be/menu/cart.php'">THANH TOÁN</button>
      <?php
      include 'add_to_cart.php';
      // Kiểm tra giỏ hàng
...
<script>
  ...
  function placeOrder() {
    ...
    fetch('place_order.php', {
      ...
      .then(data => {
        ...
        window.location.href = '/otoke-chicken/be/menu/checkout.php';
      })
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const menuItems = document.querySelectorAll(".menu-item"); // Các mục menu
    const headings = document.querySelectorAll("h3"); // Các thẻ h3 có id

    function updateActiveMenu() {
      let currentHeading = null;

      headings.forEach((heading) => {
        const headingTop = heading.getBoundingClientRect().top; // Vị trí so với viewport
        const headingHeight = heading.offsetHeight;

        // Kiểm tra xem tiêu đề (h3) đã đi vào vùng nhìn thấy
      ...
      menuItems.forEach((item) => {
        ...
        if (link && link.getAttribute("href").includes(currentHeading)) {
